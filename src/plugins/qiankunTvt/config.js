 ...
 * @LastEditors: 地虎降天龙
 * @LastEditTime: 2025-04-08 09:21:21
 */
export default {
    name: 'qiankunTvt',
    title: '微前端qiankun',
    intro: `本案例结合qiankun微前端框架，演示了如何把tvt以子应用引入到自己的主应用框架中，并且实现了qiankun的沙箱隔离机制。qiankun是一个基于single-spa的微前端框架，支持多种主应用和子应用的组合方式。</br>
    演示地址：<a style="color:#5384ff;" href="https://demo.icegl.cn" target="_blank">demo.icegl.cn</a></br>
    教程文档：<a style="color:#5384ff;" href="https://www.icegl.cn/tvtstore/qiankunTvt" target="_blank">详细教程</a></br>`,
    version: '1.0.0',
    author: '地虎降天龙',
    ...
    preview: [
        {
            ...
            先看演示地址：<a style="color: #ff00ff;" href="https://demo.icegl.cn" target="_blank">demo.icegl.cn</a></br>
